...
public class AvlTree_findMaxTest {
    ...
    public void test0() {
        ...
        new AccessibleObject(__ROOT_this).get("root").get("right").set("height", 1);  // {V11} >= 0
        new AccessibleObject(__ROOT_this).get("root").get("right").set("element", 1);new AccessibleObject(__ROOT_this).get("root").set("element", 0);   // {V10} > {V2}
        ...
        new AccessibleObject(__ROOT_this).get("root").get("right").get("right").set("height", 1);  // {V16} >= 0
        new AccessibleObject(__ROOT_this).get("root").get("right").get("right").set("element", 2);  // {V15} > {V10}
         // {V11} >= 1
        new AccessibleObject(__ROOT_this).get("root").get("right").get("right").set("right", newInstance("avl_tree.AvlNode")); // {R19} == Object[11] (fresh)
        new AccessibleObject(__ROOT_this).get("root").get("right").get("right").get("right").set("parent", new AccessibleObject(__ROOT_this).get("root").get("right").get("right").getValue()); // {R24} == Object[9] (aliases {ROOT}:this.root.right.right)
        new AccessibleObject(__ROOT_this).get("root").get("right").get("right").get("right").set("height", 0);  // {V21} >= 0
        new AccessibleObject(__ROOT_this).get("root").get("right").get("right").get("right").set("element", 3);  // {V20} > {V15}
         // {V16} >= 1
        new AccessibleObject(__ROOT_this).get("root").get("right").get("right").get("right").set("right", newInstance("avl_tree.AvlNode")); // {R26} == Object[13] (fresh)
        new AccessibleObject(__ROOT_this).get("root").get("right").get("right").get("right").get("right").set("parent", new AccessibleObject(__ROOT_this).get("root").get("right").get("right").get("right").getValue()); // {R31} == Object[11] (aliases {ROOT}:this.root.right.right.right)
    ...
    public void test1() {
        ...
        new AccessibleObject(__ROOT_this).get("root").get("right").get("right").set("right", newInstance("avl_tree.AvlNode")); // {R19} == Object[11] (fresh)
        new AccessibleObject(__ROOT_this).get("root").get("right").get("right").get("right").set("parent", new AccessibleObject(__ROOT_this).get("root").get("right").get("right").getValue()); // {R24} == Object[9] (aliases {ROOT}:this.root.right.right)
        new AccessibleObject(__ROOT_this).get("root").get("right").get("right").get("right").set("height", 1);  // {V21} >= 0
        new AccessibleObject(__ROOT_this).get("root").get("right").get("right").get("right").set("element", 3);  // {V20} > {V15}
         // {V16} >= 1
        new AccessibleObject(__ROOT_this).get("root").get("right").get("right").get("right").set("right", null);this.nullObjectFields.add(new ObjectField(new AccessibleObject(__ROOT_this).get("root").get("right").get("right").get("right").getValue(), "right")); // {R26} == null
         // {V21} <= 1
        if (__ROOT_this.repOK()) {
        	System.out.println("true");
        	__ROOT_this.findMax();
    ...
    public void test2() {
        ...
        new AccessibleObject(__ROOT_this).get("root").get("right").get("right").set("right", newInstance("avl_tree.AvlNode")); // {R19} == Object[11] (fresh)
        new AccessibleObject(__ROOT_this).get("root").get("right").get("right").get("right").set("parent", new AccessibleObject(__ROOT_this).get("root").get("right").get("right").getValue()); // {R24} == Object[9] (aliases {ROOT}:this.root.right.right)
        new AccessibleObject(__ROOT_this).get("root").get("right").get("right").get("right").set("height", 2);  // {V21} >= 0
        new AccessibleObject(__ROOT_this).get("root").get("right").get("right").get("right").set("element", 3);  // {V20} > {V15}
         // {V16} >= 1
        new AccessibleObject(__ROOT_this).get("root").get("right").get("right").get("right").set("right", null);this.nullObjectFields.add(new ObjectField(new AccessibleObject(__ROOT_this).get("root").get("right").get("right").get("right").getValue(), "right")); // {R26} == null
         // {V21} > 1
