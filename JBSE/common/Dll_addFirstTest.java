...
public class Dll_addFirstTest {
    ...
    @Test
    public void test0() {
        //test case for state .1.1.1.1.1[57]
        ...
        if (__ROOT_this.repOK()) {
        	...
        	__ROOT_this.addFirst(__ROOT_e);
        }
//        __ROOT_this.addFirst(__ROOT_e);
    }
    @Test
    public void test1() {
        //test case for state .1.1.1.2.1.2[63]
        this.nullObjectFields = new HashSet<>();
        common.LinkedList __ROOT_this = (common.LinkedList) newInstance("common.LinkedList"); // {R0} == Object[0] (fresh)
        ; // pre_init(common/LinkedList)
        ; // pre_init(java/util/AbstractSequentialList)
...
//        __ROOT_this.addFirst(__ROOT_e);
    ...
    @Test
    public void test2() {
        //test case for state .1.1.2.1.1[57]
        this.nullObjectFields = new HashSet<>();
        common.LinkedList __ROOT_this = (common.LinkedList) newInstance("common.LinkedList"); // {R0} == Object[0] (fresh)
        ; // pre_init(common/LinkedList)
        ; // pre_init(java/util/AbstractSequentialList)
...
//        __ROOT_this.addFirst(__ROOT_e);
    ...
    @Test
    public void test3() {
        //test case for state .1.1.2.2.1.2[63]
        this.nullObjectFields = new HashSet<>();
        common.LinkedList __ROOT_this = (common.LinkedList) newInstance("common.LinkedList"); // {R0} == Object[0] (fresh)
        ; // pre_init(common/LinkedList)
        ; // pre_init(java/util/AbstractSequentialList)
