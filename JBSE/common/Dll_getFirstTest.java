...
public class Dll_getFirstTest {
    ...
    public void test0() {
        ...
        if (__ROOT_this.repOK()) {
        	...
        	__ROOT_this.getFirst();
        }
//        __ROOT_this.getFirst();
    }
    @Test
    public void test1() {
        //test case for state .1.1.2.1.1[1]
        this.nullObjectFields = new HashSet<>();
        common.LinkedList __ROOT_this = (common.LinkedList) newInstance("common.LinkedList"); // {R0} == Object[0] (fresh)
        ; // pre_init(common/LinkedList)
        ; // pre_init(java/util/AbstractSequentialList)
...
//        common.LinkedList __returnedValue = __ROOT_this.getFirst();
...
//        common.LinkedList.Entry __returnedValue = __ROOT_this.getFirst();
//        assertTrue(__returnedValue == new AccessibleObject(__ROOT_this).get("header").getValue());
    }
    @Test
    public void test3() {
        //test case for state .1.1.2.1.3[1]
        this.nullObjectFields = new HashSet<>();
        common.LinkedList __ROOT_this = (common.LinkedList) newInstance("common.LinkedList"); // {R0} == Object[0] (fresh)
        ; // pre_init(common/LinkedList)
        ; // pre_init(java/util/AbstractSequentialList)
...
//        assertTrue(__returnedValue == new AccessibleObject(__ROOT_this).get("header").get("next").getValue());
    ...
    @Test
    public void test4() {
        //test case for state .1.1.2.1.4[1]
        this.nullObjectFields = new HashSet<>();
        common.LinkedList __ROOT_this = (common.LinkedList) newInstance("common.LinkedList"); // {R0} == Object[0] (fresh)
        ; // pre_init(common/LinkedList)
        ; // pre_init(java/util/AbstractSequentialList)
...
//        java.lang.Object __returnedValue = __ROOT_this.getFirst();
