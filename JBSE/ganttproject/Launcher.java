...
public class Launcher {
	...
	private static void fill(RunParameters p) {
		try {
			SettingsReader sr = new SettingsReader(examplesHome + "settings/ganttproject_accurate.jbse");
...
//		p.setMethodSignature("ganttproject/DependencyGraph", "()V", "startTransaction");
		p.setMethodSignature("ganttproject/DependencyGraph", "()V", "rollbackTransaction");
