...
public class TreeMap_constainsValueTest {
    ...
    @Test
    public void test0() {
        //test case for state .1.1.1.1.1.2.1[28]
        ...
        if (__ROOT_this.repOK()) {
        	...
        	__ROOT_this.containsValue(__ROOT_value);
        }
//        boolean __returnedValue = __ROOT_this.containsValue(__ROOT_value);
//        assertTrue(__returnedValue == true);
    }
    @Test
    public void test1() {
        //test case for state .1.1.1.2.1[11]
        this.nullObjectFields = new HashSet<>();
        treemap.TreeMap __ROOT_this = (treemap.TreeMap) newInstance("treemap.TreeMap"); // {R0} == Object[0] (fresh)
        ; // pre_init(treemap/TreeMap)
        ; // !pre_init(java/lang/Object)
        ...
        if (__ROOT_this.repOK()) {
        	System.out.println("true");
        	__ROOT_this.containsValue(null);
        }
//        boolean __returnedValue = __ROOT_this.containsValue(null);
