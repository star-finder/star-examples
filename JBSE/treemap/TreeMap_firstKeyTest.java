...
public class TreeMap_firstKeyTest {
    ...
    public void test0() {
        ...
        new AccessibleObject(__ROOT_this).get("root").get("left").set("_owner", __ROOT_this); // {R18} == Object[0] (aliases {ROOT}:this)
         // {V0} >= 2
        new AccessibleObject(__ROOT_this).get("root").get("left").set("color", (0 != 0));  // WIDEN-I({V23}) == 0
        new AccessibleObject(__ROOT_this).get("root").set("key", 0);new AccessibleObject(__ROOT_this).get("root").get("left").set("key", -1);   // {V22} < {V11}
        new AccessibleObject(__ROOT_this).get("root").get("left").set("left", newInstance("treemap.TreeMap$Entry")); // {R12} == Object[3] (fresh)
        new AccessibleObject(__ROOT_this).get("root").get("left").get("left").set("parent", new AccessibleObject(__ROOT_this).get("root").get("left").getValue()); // {R22} == Object[2] (aliases {ROOT}:this.root.left)
        new AccessibleObject(__ROOT_this).get("root").get("left").get("left").set("_owner", __ROOT_this); // {R26} == Object[0] (aliases {ROOT}:this)
         // {V0} >= 3
        if (__ROOT_this.repOK()) {
        	System.out.println("true");
        	__ROOT_this.firstKey();
        }
//        __ROOT_this.firstKey();
    }
    @Test
...
//        __ROOT_this.firstKey();
    ...
    public void test2() {
        ...
        new AccessibleObject(__ROOT_this).get("root").get("left").set("color", (0 != 0));  // WIDEN-I({V23}) == 0
        new AccessibleObject(__ROOT_this).get("root").set("key", 0);new AccessibleObject(__ROOT_this).get("root").get("left").set("key", -1);   // {V22} < {V11}
        new AccessibleObject(__ROOT_this).get("root").get("left").set("left", null);this.nullObjectFields.add(new ObjectField(new AccessibleObject(__ROOT_this).get("root").get("left").getValue(), "left")); // {R12} == null
         // {V4} == 1
        if (__ROOT_this.repOK()) {
        	System.out.println("true");
        	__ROOT_this.firstKey();
        }
//        long __returnedValue = __ROOT_this.firstKey();
//        assertTrue(__returnedValue == {V22});
    ...
    public void test3() {
        ...
        new AccessibleObject(__ROOT_this).get("root").set("_owner", __ROOT_this); // {R10} == Object[0] (aliases {ROOT}:this)
         // {V0} >= 1
        new AccessibleObject(__ROOT_this).get("root").set("color", (4 != 0));  // WIDEN-I({V12}) != 0
         // {V4} >= 1
        new AccessibleObject(__ROOT_this).get("root").set("left", newInstance("treemap.TreeMap$Entry")); // {R4} == Object[2] (fresh)
        new AccessibleObject(__ROOT_this).get("root").get("left").set("parent", new AccessibleObject(__ROOT_this).get("root").getValue()); // {R14} == Object[1] (aliases {ROOT}:this.root)
        new AccessibleObject(__ROOT_this).get("root").get("left").set("_owner", __ROOT_this); // {R18} == Object[0] (aliases {ROOT}:this)
         // {V0} >= 2
        new AccessibleObject(__ROOT_this).get("root").get("left").set("color", (5 != 0));  // WIDEN-I({V23}) != 0
         // {V4} >= 2
        new AccessibleObject(__ROOT_this).get("root").set("key", 1);new AccessibleObject(__ROOT_this).get("root").get("left").set("key", 0);   // {V22} < {V11}
        new AccessibleObject(__ROOT_this).get("root").get("left").set("left", newInstance("treemap.TreeMap$Entry")); // {R12} == Object[3] (fresh)
        new AccessibleObject(__ROOT_this).get("root").get("left").get("left").set("parent", new AccessibleObject(__ROOT_this).get("root").get("left").getValue()); // {R22} == Object[2] (aliases {ROOT}:this.root.left)
        new AccessibleObject(__ROOT_this).get("root").get("left").get("left").set("_owner", __ROOT_this); // {R26} == Object[0] (aliases {ROOT}:this)
         // {V0} >= 3
...
//        __ROOT_this.firstKey();
    ...
    public void test4() {
        ...
        new AccessibleObject(__ROOT_this).get("root").get("left").set("_owner", __ROOT_this); // {R18} == Object[0] (aliases {ROOT}:this)
         // {V0} >= 2
        new AccessibleObject(__ROOT_this).get("root").get("left").set("color", (4 != 0));  // WIDEN-I({V23}) != 0
         // {V4} >= 2
        new AccessibleObject(__ROOT_this).get("root").set("key", 1);new AccessibleObject(__ROOT_this).get("root").get("left").set("key", 0);   // {V22} < {V11}
        new AccessibleObject(__ROOT_this).get("root").get("left").set("left", newInstance("treemap.TreeMap$Entry")); // {R12} == Object[3] (fresh)
        new AccessibleObject(__ROOT_this).get("root").get("left").get("left").set("parent", new AccessibleObject(__ROOT_this).get("root").get("left").getValue()); // {R22} == Object[2] (aliases {ROOT}:this.root.left)
