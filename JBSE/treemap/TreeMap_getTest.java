...
public class TreeMap_getTest {
    ...
    @Test
    public void test0() {
        //test case for state .1.1.1.1.1.2.1.1[8]
        ...
        if (__ROOT_this.repOK()) {
        	...
        	__ROOT_this.get(__ROOT_key);
        }
//        java.lang.Object __returnedValue = __ROOT_this.get(__ROOT_key);
...
//        __ROOT_this.get(__ROOT_key);
    ...
    @Test
    public void test7() {
        //test case for state .1.1.1.1.1.2.1.2.1.2.1[19]
        this.nullObjectFields = new HashSet<>();
        treemap.TreeMap __ROOT_this = (treemap.TreeMap) newInstance("treemap.TreeMap"); // {R0} == Object[0] (fresh)
        ; // pre_init(treemap/TreeMap)
        ; // !pre_init(java/lang/Object)
...
//        __ROOT_this.get(__ROOT_key);
    ...
    @Test
    public void test14() {
        //test case for state .1.1.1.1.1.2.1.2.2.2.1[18]
        this.nullObjectFields = new HashSet<>();
        treemap.TreeMap __ROOT_this = (treemap.TreeMap) newInstance("treemap.TreeMap"); // {R0} == Object[0] (fresh)
        ; // pre_init(treemap/TreeMap)
        ; // !pre_init(java/lang/Object)
...
//        __ROOT_this.get(__ROOT_key);
    ...
    @Test
    public void test15() {
        //test case for state .1.1.1.2.1[21]
        this.nullObjectFields = new HashSet<>();
        treemap.TreeMap __ROOT_this = (treemap.TreeMap) newInstance("treemap.TreeMap"); // {R0} == Object[0] (fresh)
        ; // pre_init(treemap/TreeMap)
        ; // !pre_init(java/lang/Object)
