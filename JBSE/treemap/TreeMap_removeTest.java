...
public class TreeMap_removeTest {
    ...
    @Test
    public void test0() {
        //test case for state .1.1.1.1.1.2.1.1.1.1.1.1.1[13]
        ...
        new AccessibleObject(__ROOT_this).get("root").set("color", (3 != 0));  // WIDEN-I({V13}) != 0
         // {V4} >= 1
        int __ROOT_key = 1;new AccessibleObject(__ROOT_this).get("root").set("key", 1);   // {V7} == {V12}
        new AccessibleObject(__ROOT_this).get("root").set("value", null);this.nullObjectFields.add(new ObjectField(new AccessibleObject(__ROOT_this).get("root").getValue(), "value")); // {R3} == null
        ...
        new AccessibleObject(__ROOT_this).get("root").get("left").set("key", 0);  // {V23} < {V7}
        new AccessibleObject(__ROOT_this).get("root").set("right", newInstance("treemap.TreeMap$Entry")); // {R5} == Object[3] (fresh)
        new AccessibleObject(__ROOT_this).get("root").get("right").set("parent", new AccessibleObject(__ROOT_this).get("root").getValue()); // {R22} == Object[1] (aliases {ROOT}:this.root)
        if (__ROOT_this.repOK()) {
        	System.out.println("true");
        	__ROOT_this.remove(__ROOT_key);
        }
//        __ROOT_this.remove(__ROOT_key);
    }
    @Test
    public void test1() {
        //test case for state .1.1.1.1.1.2.1.1.1.1.1.1.2.1[0]
        this.nullObjectFields = new HashSet<>();
        treemap.TreeMap __ROOT_this = (treemap.TreeMap) newInstance("treemap.TreeMap"); // {R0} == Object[0] (fresh)
        ; // pre_init(treemap/TreeMap)
        ; // !pre_init(java/lang/Object)
...
//        __ROOT_this.remove(__ROOT_key);
    ...
    @Test
    public void test2() {
        //test case for state .1.1.1.1.1.2.1.1.1.1.1.1.2.2[1]
        this.nullObjectFields = new HashSet<>();
        treemap.TreeMap __ROOT_this = (treemap.TreeMap) newInstance("treemap.TreeMap"); // {R0} == Object[0] (fresh)
        ; // pre_init(treemap/TreeMap)
        ; // !pre_init(java/lang/Object)
...
//        __ROOT_this.remove(__ROOT_key);
    ...
    @Test
    public void test3() {
        //test case for state .1.1.1.1.1.2.1.1.1.1.2.1.1.1[13]
        this.nullObjectFields = new HashSet<>();
        treemap.TreeMap __ROOT_this = (treemap.TreeMap) newInstance("treemap.TreeMap"); // {R0} == Object[0] (fresh)
        ; // pre_init(treemap/TreeMap)
        ; // !pre_init(java/lang/Object)
        ...
        new AccessibleObject(__ROOT_this).get("root").get("left").set("_owner", __ROOT_this); // {R18} == Object[0] (aliases {ROOT}:this)
         // {V0} >= 2
        new AccessibleObject(__ROOT_this).get("root").get("left").set("color", (4 != 0));  // WIDEN-I({V24}) != 0
         // {V4} >= 2
        new AccessibleObject(__ROOT_this).get("root").get("left").set("key", 0);  // {V23} < {V7}
        new AccessibleObject(__ROOT_this).get("root").set("right", newInstance("treemap.TreeMap$Entry")); // {R5} == Object[3] (fresh)
        new AccessibleObject(__ROOT_this).get("root").get("right").set("parent", new AccessibleObject(__ROOT_this).get("root").getValue()); // {R22} == Object[1] (aliases {ROOT}:this.root)
...
//        __ROOT_this.remove(__ROOT_key);
    ...
    @Test
    public void test4() {
        //test case for state .1.1.1.1.1.2.1.1.1.1.2.1.1.2[25]
        this.nullObjectFields = new HashSet<>();
        treemap.TreeMap __ROOT_this = (treemap.TreeMap) newInstance("treemap.TreeMap"); // {R0} == Object[0] (fresh)
        ; // pre_init(treemap/TreeMap)
        ; // !pre_init(java/lang/Object)
...
//        __ROOT_this.remove(__ROOT_key);
    ...
    @Test
    public void test5() {
        //test case for state .1.1.1.1.1.2.1.1.2.1.1.1.1.1[0]
        this.nullObjectFields = new HashSet<>();
        treemap.TreeMap __ROOT_this = (treemap.TreeMap) newInstance("treemap.TreeMap"); // {R0} == Object[0] (fresh)
        ; // pre_init(treemap/TreeMap)
        ; // !pre_init(java/lang/Object)
        ...
        new AccessibleObject(__ROOT_this).get("root").get("right").set("key", 0);  // {V23} > {V7}
        if (__ROOT_this.repOK()) {
        	System.out.println("true");
        	__ROOT_this.remove(__ROOT_key);
        }
//        __ROOT_this.remove(__ROOT_key);
    ...
    @Test
    public void test6() {
        //test case for state .1.1.1.1.1.2.1.1.2.1.1.1.1.2[1]
        this.nullObjectFields = new HashSet<>();
        treemap.TreeMap __ROOT_this = (treemap.TreeMap) newInstance("treemap.TreeMap"); // {R0} == Object[0] (fresh)
        ; // pre_init(treemap/TreeMap)
        ; // !pre_init(java/lang/Object)
...
//        __ROOT_this.remove(__ROOT_key);
    ...
    @Test
    public void test7() {
        //test case for state .1.1.1.1.1.2.1.1.2.1.2.1[45]
        this.nullObjectFields = new HashSet<>();
        treemap.TreeMap __ROOT_this = (treemap.TreeMap) newInstance("treemap.TreeMap"); // {R0} == Object[0] (fresh)
        ; // pre_init(treemap/TreeMap)
        ; // !pre_init(java/lang/Object)
...
//        java.lang.Object __returnedValue = __ROOT_this.remove(__ROOT_key);
//        assertTrue(__returnedValue == null);
    }
    @Test
    public void test8() {
        //test case for state .1.1.1.1.1.2.1.2.1.1.1.1.1.1[7]
        this.nullObjectFields = new HashSet<>();
        treemap.TreeMap __ROOT_this = (treemap.TreeMap) newInstance("treemap.TreeMap"); // {R0} == Object[0] (fresh)
        ; // pre_init(treemap/TreeMap)
        ; // !pre_init(java/lang/Object)
        ...
        new AccessibleObject(__ROOT_this).get("root").get("left").set("key", -2);  // {V23} < {V12}
         // {V7} == {V23}
        new AccessibleObject(__ROOT_this).get("root").get("left").set("value", null);this.nullObjectFields.add(new ObjectField(new AccessibleObject(__ROOT_this).get("root").get("left").getValue(), "value")); // {R11} == null
        if (__ROOT_this.repOK()) {
        	System.out.println("true");
        	__ROOT_this.remove(__ROOT_key);
        }
...
//        __ROOT_this.remove(__ROOT_key);
    ...
    @Test
    public void test11() {
        //test case for state .1.1.1.1.1.2.1.2.1.1.1.2.1.1.1[7]
        this.nullObjectFields = new HashSet<>();
        treemap.TreeMap __ROOT_this = (treemap.TreeMap) newInstance("treemap.TreeMap"); // {R0} == Object[0] (fresh)
        ; // pre_init(treemap/TreeMap)
        ; // !pre_init(java/lang/Object)
...
//        __ROOT_this.remove(__ROOT_key);
    ...
    public void test13() {
        ...
        new AccessibleObject(__ROOT_this).get("root").get("left").set("_owner", __ROOT_this); // {R18} == Object[0] (aliases {ROOT}:this)
         // {V0} >= 2
        new AccessibleObject(__ROOT_this).get("root").get("left").set("color", (6 != 0));  // WIDEN-I({V24}) != 0
         // {V4} >= 2
...
//        __ROOT_this.remove(__ROOT_key);
    ...
    @Test
    public void test14() {
        //test case for state .1.1.1.1.1.2.1.2.1.2.1[18]
        this.nullObjectFields = new HashSet<>();
        treemap.TreeMap __ROOT_this = (treemap.TreeMap) newInstance("treemap.TreeMap"); // {R0} == Object[0] (fresh)
        ; // pre_init(treemap/TreeMap)
        ; // !pre_init(java/lang/Object)
...
//        __ROOT_this.remove(__ROOT_key);
    ...
    @Test
    public void test15() {
        //test case for state .1.1.1.1.1.2.1.2.2.1.1.1.1.1[7]
        this.nullObjectFields = new HashSet<>();
        treemap.TreeMap __ROOT_this = (treemap.TreeMap) newInstance("treemap.TreeMap"); // {R0} == Object[0] (fresh)
        ; // pre_init(treemap/TreeMap)
        ; // !pre_init(java/lang/Object)
        ...
        new AccessibleObject(__ROOT_this).get("root").get("right").set("key", 0);  // {V23} > {V12}
         // {V7} == {V23}
        new AccessibleObject(__ROOT_this).get("root").get("right").set("value", null);this.nullObjectFields.add(new ObjectField(new AccessibleObject(__ROOT_this).get("root").get("right").getValue(), "value")); // {R11} == null
        if (__ROOT_this.repOK()) {
        	System.out.println("true");
        	__ROOT_this.remove(__ROOT_key);
        }
...
//        __ROOT_this.remove(__ROOT_key);
    ...
    @Test
    public void test18() {
        //test case for state .1.1.1.1.1.2.1.2.2.1.1.2.1.1.1[7]
        this.nullObjectFields = new HashSet<>();
        treemap.TreeMap __ROOT_this = (treemap.TreeMap) newInstance("treemap.TreeMap"); // {R0} == Object[0] (fresh)
        ; // pre_init(treemap/TreeMap)
        ; // !pre_init(java/lang/Object)
...
//        __ROOT_this.remove(__ROOT_key);
    ...
    @Test
    public void test21() {
        //test case for state .1.1.1.1.1.2.1.2.2.2.1[17]
        this.nullObjectFields = new HashSet<>();
        treemap.TreeMap __ROOT_this = (treemap.TreeMap) newInstance("treemap.TreeMap"); // {R0} == Object[0] (fresh)
        ; // pre_init(treemap/TreeMap)
        ; // !pre_init(java/lang/Object)
...
//        __ROOT_this.remove(__ROOT_key);
    ...
    @Test
    public void test22() {
        //test case for state .1.1.1.2.1[20]
        this.nullObjectFields = new HashSet<>();
        treemap.TreeMap __ROOT_this = (treemap.TreeMap) newInstance("treemap.TreeMap"); // {R0} == Object[0] (fresh)
        ; // pre_init(treemap/TreeMap)
        ; // !pre_init(java/lang/Object)
